...
insert into teme.categoria values(1,"Bicicletas Eléctricas"),(2,"Monopatines"),(3,"Skateboards"),(4,"Hoverboards"),(5,"Accesorioscategoriacategoriacategoriacategoria");

/************************************compra **********************************************/
CREATE TABLE `teme`.`compra` (
  `id` INT NOT NULL,
  `precio` FLOAT NULL,
  `descripcion` VARCHAR(100) NULL,
  `fechacompra` DATE NULL,
  `metododepado_id` INT NULL,
  `envio_id` INT NULL,
  PRIMARY KEY (`id`));
  
  
/**********************compraproducto ******************************/
CREATE TABLE `teme`.`compraproducto` (
  `id` INT NOT NULL,
  `compra_id` INT NULL,
...
insert into teme.metododepago values(1,"Efectivo"),(2,"Tarjeta de Debito"),(3,"Tarjeta de Credito"),(4,"Transferencia");

/*********************************producto ****************************/
CREATE TABLE `teme`.`producto` (
  `id` INT NOT NULL,
...
CREATE TABLE `teme`.`usuario` (
  ...
  insert into teme.usuario values(1,"pedro perez","pepito","pepito@gmail.com","$2a$10$Lt2eO8cb.UV9t7tZ4wMOzOrGrB0BG92zcyzTlgSjdcPX6/FI2cjeO","faltaimg.jpg",2);


/*************************usuario compra**************************************************/
CREATE TABLE `teme`.`usuariocompra` (
  `id` INT NOT NULL,
  `usuario_id` INT NULL,
  `compra_id` INT NULL,
  PRIMARY KEY (`id`));
